...
class CourseOrg(BaseModel):
    ...
    city = models.ForeignKey(City, on_delete=models.CASCADE, verbose_name="所在城市")   #外键
...
class Teacher(BaseModel):
    ...
    #外键 一个teacher对应一个user
    org = models.ForeignKey(CourseOrg, on_delete=models.CASCADE, verbose_name="所属机构") #外键 该老师属于哪个课程机构

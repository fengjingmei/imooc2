...
class CourseComments(BaseModel):
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name="用户")  #外键 用户可以发出多个评论
    #UserProfile = get_user_model() 可以调用settings中的AUTH_USER_MODEL从而使用UserProfile
    course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="课程")  #外键  可以对多个课程进行评论
...
class UserFavorite(BaseModel):
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name="用户")  #外键
